...
/* define to 1 if we have support for gcc x86/x86_64 bit primitives */
#ifndef OPA_HAVE_GCC_X86_32_64 
#define OPA_HAVE_GCC_X86_32_64  1 
#endif

/* define to 1 if we have support for gcc x86 bit primitives for pre-Pentium 4
   */
...
#define OPA_PACKAGE_STRING  "OpenPA 1.0.2" 
#endif
...
#define OPA_PACKAGE_VERSION  "1.0.2" 
#endif
